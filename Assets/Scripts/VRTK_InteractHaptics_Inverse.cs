...
namespace VRTK
{
    ...
    public struct InteractHapticsEventArgs_Inverse
    {
    ...
    public delegate void InteractHapticsEventHandler_Inverse(object sender, InteractHapticsEventArgs e);
    ...
    public class VRTK_InteractHaptics_Inverse : VRTK_InteractableListener
    {
        [Header("Haptics On Near UnTouch Settings")]
        ...
        [Header("Haptics On UnTouch Settings")]
        ...
        [Header("Haptics On UnGrab Settings")]
        ...
        [Header("Haptics On UnUse Settings")]
